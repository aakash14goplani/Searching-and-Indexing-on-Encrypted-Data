        ...
        <div class="section secondary-section " id="portfolio">
            ...
            <div class="container">
                ...
                <table border="1" align="center" cellpadding="10" cellspacing="10">
                    ...
                    <tr>
                        <th>MULTIMEDIA</th>
                        <td><a href="mmFileUpload.php">Upload multimedia files</a></td>
                        <td><a href="mmFileSearch.php">Search multimedia files</a></td>
                    </tr>
                    <tr>
                        <th>DATABASE</th>
                        <td><a href="databaseFileUpload.php">Upload database files</a></td>
                        <td><a href="databaseFileSearch.php">Search database files</a></td>
                    </tr>
                </table>
            </div>
        </div>
