                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse pull-right">
                        <ul class="nav" id="top-navigation">
                            ...
                            <li><a href="mmFileSearch.php">Search with other Query</a></li>
                            <li><a href="multimediaSearchReport.php" target="_blank">Generate Report</a></li>
            ...
            <div class="container">
                ...
                <?php
                    if($_SERVER["REQUEST_METHOD"] == "POST")
					{
						...
						$query11 = mysql_query(" SELECT * FROM mmfileindex ") or die(mysql_error());
						...
						if(strlen($text) > 3)
						{
							...
							{
								$query1 = mysql_query(" SELECT * FROM mmkeywordindex WHERE keyword like '%".$key."%' OR keyword like '".$key."%' OR keyword like '%".$key."' ") or die(mysql_error());
								...
								if(mysql_num_rows($query1))
								{
									while($rows = mysql_fetch_assoc($query1))
									{
										...
										if($id)
										{
											$query2 = mysql_query(" SELECT file_name FROM mmfileindex WHERE file_id = $id ") or die(mysql_error());
								...
								$query3 = mysql_query(" SELECT COUNT(keyword) as total FROM mmkeywordindex WHERE keyword like '%".$key."%' OR keyword like '".$key."%' OR keyword like '%".$key."' ") or die(mysql_error());
					...
					$query44 = "insert into topkencryptresults(file_id, file_name, idf) values (AES_ENCRYPT('".$id."', '".$aesKey."'), AES_ENCRYPT('".$name."', '".$aesKey."'), ".$idf.")";
							...
							$_SESSION['untustedCloudMMSearch_time'] = $totalTimeUntrustedCloud;
							...
							$_SESSION['tustedCloudMMSearch_time'] = $totalTimeTrustedCloud;
						}
						
						$endTime = microtime(true);
						$totalTime = $endTime - $startTime;
						$_SESSION['totalSearchMM_time'] = $totalTime;
					}
				?>
						<h2>Download Options</h2>
						<table border="0" cellpadding="4" cellspacing="4" align="center">
							<tr>
								<form name="fileDownload" action="enterTokenMM.php" method="post">
									<th>Enter File Id</th>
									<td><input type="text" name="fileid" required></td>
									<th>Download contents of file</th>
									<td><input type="submit" value="Download File"></td>
								</form>
							</tr>
							<tr>
								<form name="fileDownload" action="enterTokenActualMedia.php" method="post">
									<th>Enter File Id</th>
									<td><input type="text" name="fileid" required></td>
									<th>Download actual media file</th>
									<td><input type="submit" value="Download File"></td>
								</form>
							</tr>
							<tr>
								<form name="fileDownload" action="enterTokenBothMM.php" method="post">
									<th>Enter File Id</th>
									<td><input type="text" name="fileid" required></td>
									<th>Download Both</th>
									<td><input type="submit" value="Download File"></td>
