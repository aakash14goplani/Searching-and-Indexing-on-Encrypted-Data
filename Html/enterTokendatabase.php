...
<html lang="en">
    ...
    <body>
            ...
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <?php
						...
						$_SESSION['columns'] = $pcolumns;
						$_SESSION['table'] = $ptable;
						$_SESSION['where'] = $pwhere;
					?>
                    ...
                    <div class="nav-collapse collapse pull-right">
                        <ul class="nav" id="top-navigation">
                            ...
                            <li><a href="databaseFileSearch.php">Back</a></li>
        ...
        <div class="section secondary-section " id="portfolio">
            ...
            <div class="container">
                <div class=" title">
                    <h1>Enter Acces Token to Download Records</h1>
                </div>
                <form name="enterToken" action="searchdatabase.php" method="post">
